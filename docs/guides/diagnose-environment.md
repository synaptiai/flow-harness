...
Flow `0.1.0-alpha.4` and the current source tree contain this command. Follow the
[versioned installation guide](install-preview.md) for the current package boundary.

## Before you begin

Install Flow `0.1.0-alpha.4` through the [versioned installation guide](install-preview.md). If you
