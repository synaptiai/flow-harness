...
| [Host-bridge runtime custody proposal](host-bridge-runtime-custody-design.md) | You need the relay artifact, runtime compatibility, and admission options that must be resolved before observer-manager integration. |
