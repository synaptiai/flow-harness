...
flowchart TB
    ...
    subgraph observerChecks["Verification-observer qualification — not connected to issue runs"]
        ...
        observerLaunch["Proxy-free observer launch rewrite<br/>Current production wrapper unsupported<br/>Does not start a process"]
