...
| BR-05 | Adversarial and crash-boundary verification. | Independent security/code review, real-process tests, sandbox tests, and all existing quality gates. | Independent review, local gates, and hosted quality checks passed. The separate hosted proof job remains active. |
