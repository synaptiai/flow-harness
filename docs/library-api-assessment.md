...
| Exported top-level declarations | 3,002 | Export syntax currently marks internal seams, test seams, schemas, records, and adapters. |
...
| Infrastructure declarations | 976 | These declarations can reach files, processes, networks, sandboxes, containers, credentials, and UI hosts. |
