...
| --- | --- | --- |
| Production TypeScript files | 380 | A broad root export would expose most of the product, not a small SDK. |
| Exported top-level declarations | 3,455 | Export syntax currently marks internal seams, test seams, schemas, records, and adapters. |
...
| Infrastructure declarations | 1,098 | These declarations can reach files, processes, networks, sandboxes, containers, credentials, and UI hosts. |
| Supervisor declarations | 122 | These declarations own queues, worker processes, control requests, and shutdown. |
| CLI declarations | 25 | The CLI composes 346 of 380 production modules and is the intentional product boundary. |
