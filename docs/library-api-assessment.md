...
| Exported top-level declarations | 2,968 | Export syntax currently marks internal seams, test seams, schemas, records, and adapters. |
| Domain declarations | 1,483 | Even the provider-neutral layer contains large workflow, event, evaluation, package, and adaptation contracts. |
| Application declarations | 398 | Use cases expose ports for stores, executors, approvals, artifacts, workspaces, and sessions. |
| Infrastructure declarations | 948 | These declarations can reach files, processes, networks, sandboxes, containers, credentials, and UI hosts. |
