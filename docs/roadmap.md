...
- Open operations are reconciled before retry. *(Typed edit evidence is available; automatic hash-based reconciliation and retry remain planned, and the current slice refuses the open attempt.)*
