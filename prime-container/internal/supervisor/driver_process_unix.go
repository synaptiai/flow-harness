...
func closedPrimeDriverStageLine(value string) (string, bool) {
	...
	case "Prime driver stage failure: read-supervisor-input",
		...
		"Prime driver stage failure: prepare-ipython-kernel-connection",
		"Prime driver stage failure: launch-ipython-kernel",
		"Prime driver stage failure: resolve-ipython-kernel-connection",
		"Prime driver stage failure: probe-ipython-kernel",
		"Prime driver stage failure: bootstrap-ipython-kernel",
