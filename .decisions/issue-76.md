...
write, bundle read, object creation, object open, object inspection, link resolution, and working
directory resolution. Pinned runtime-init categories distinguish init-binary preparation,
init-process launch, isolated-device preparation, init policy, and network defaults.
