...
const VERSION_ONE_POLICY = Object.freeze({
  ...
  minPidHeadroom: 256,
  minCpuCapacity: 4,
  minImageReadBytesPerSecond: 134_217_728,
  minImageReadOperationsPerSecond: 8_192,
  preflightReadCount: 16,
  probeBytes: 4_096,
  maxProbeLatencyMs: 100,
  runtimeProbeIntervalMs: 250,
  maxConsecutiveSlowProbes: 3,
  pidsMax: 64,
