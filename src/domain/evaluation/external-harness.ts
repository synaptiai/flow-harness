...
const primeRuntimePolicySchema = z
  .object({
    ...
    minImageReadBytesPerSecond: z.literal(134_217_728),
    minImageReadOperationsPerSecond: z.literal(8_192),
    preflightReadCount: z.literal(16),
    probeBytes: z.literal(4_096),
    maxProbeLatencyMs: z.literal(100),
    runtimeProbeIntervalMs: z.literal(250),
    maxConsecutiveSlowProbes: z.literal(3),
